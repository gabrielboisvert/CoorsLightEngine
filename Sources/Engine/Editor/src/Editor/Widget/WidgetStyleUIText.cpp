...
WidgetStyleUIText::WidgetStyleUIText(Editor::UI::Text& pResource, QWidget* pParent) :
    QDialog(pParent),
    mResource(pResource),
...
void WidgetStyleUIText::initWindowCloseButton()
{
    ...
    connect(quitAtion, &QAction::triggered, this, &WidgetStyleUIText::close);
...
void WidgetStyleUIText::initCentralWidget()
{
...
void WidgetStyleUIText::initBottom()
{
    ...
    connect(cancel, &QAction::triggered, this, &WidgetStyleUIText::quit);
    ...
    connect(accept, &QAction::triggered, this, &WidgetStyleUIText::quit);
}

bool WidgetStyleUIText::eventFilter(QObject* obj, QEvent* event)
{
...
void WidgetStyleUIText::quit()
{
    close();
    setResult(0);
}

WidgetDoubleSpinBox* WidgetStyleUIText::setSpinBox(std::string pText, int& pAxisVal, QGridLayout* pLayout, int row, int column)
{
...
WidgetDoubleSpinBox* WidgetStyleUIText::setSpinBoxF(std::string pText, float& pAxisVal, QGridLayout* pLayout, int row, int column)
{
    pLayout->addWidget(new QLabel(pText.c_str()), row, column, Qt::AlignLeft);
    pLayout->addWidget(new QLabel(" "), row, column + 1, Qt::AlignRight);
...
void WidgetStyleUIText::setTexture(QBoxLayout& widLayout, Editor::UI::UIStyle& style)
{
    // Model name
...
void WidgetStyleUIText::setColor(QBoxLayout& widLayout, Editor::UI::UIStyle& style)
{
