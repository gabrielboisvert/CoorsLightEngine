...
WidgetStyleUIImageButton::WidgetStyleUIImageButton(Editor::UI::Button& pResource, QWidget* pParent) :
    QDialog(pParent),
    mResource(pResource),
...
void WidgetStyleUIImageButton::initCentralWidget()
{
    ...
    //Normal style
    {
        ...
        //texture
        {
            ...
            setTexture(*vertical, mResource.mImageStyle.normal);
        ...
        //color
        {
            ...
            setColor(*vertical, mResource.mImageStyle.normal);
            h->addWidget(right);
        }
    ...
    //Hover style
    {
        ...
        //texture
        {
            ...
            setTexture(*vertical, mResource.mImageStyle.hover);
            h->addWidget(left, Qt::AlignTop);
        ...
        //color
        {
            ...
            setColor(*vertical, mResource.mImageStyle.hover);
            h->addWidget(right);
        }
    ...
    //Press style
    {
        ...
        //texture
        {
            ...
            setTexture(*vertical, mResource.mImageStyle.press);
            h->addWidget(left, Qt::AlignTop);
        ...
        //color
        {
            ...
            setColor(*vertical, mResource.mImageStyle.press);
            h->addWidget(right);
        }
...
WidgetDoubleSpinBox* WidgetStyleUIImageButton::setSpinBox(std::string pText, int& pAxisVal, QGridLayout* pLayout, int row, int column)
{
...
void WidgetStyleUIImageButton::setTexture(QBoxLayout& widLayout, Editor::UI::UIStyle& style)
{
    // Model name
...
void WidgetStyleUIImageButton::setColor(QBoxLayout& widLayout, Editor::UI::UIStyle& style)
{
