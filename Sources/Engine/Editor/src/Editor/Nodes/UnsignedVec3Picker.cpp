...
UnsignedVec3Picker::UnsignedVec3Picker()
{
    mVec3 = std::make_shared<UnsignedVec3Out>();
    setupWidget();
}

void UnsignedVec3Picker::setupWidget()
{
    widget = new QWidget();
    ...
    //X
    {
        ...
        mSpinX = new Editor::Widget::WidgetDoubleSpinBox(0, 0, INT64_MAX);
    ...
    //Y
    {
        ...
        mSpinY = new Editor::Widget::WidgetDoubleSpinBox(0, 0, INT64_MAX);
    ...
    //Z
    {
        ...
        mSpinZ = new Editor::Widget::WidgetDoubleSpinBox(0, 0, INT64_MAX);
...
unsigned int UnsignedVec3Picker::nPorts(QtNodes::PortType const portType) const
{
...
QtNodes::NodeDataType UnsignedVec3Picker::dataType(QtNodes::PortType const portType, QtNodes::PortIndex const portIndex) const
{
    return UnsignedVec3Out().type();
}

std::shared_ptr<QtNodes::NodeData> UnsignedVec3Picker::outData(QtNodes::PortIndex const port)
{
    return mVec3;
}

QWidget* UnsignedVec3Picker::embeddedWidget()
{
    
    return widget;
}

QJsonObject UnsignedVec3Picker::save() const
{
...
void UnsignedVec3Picker::load(QJsonObject const& p)
{
    QJsonValue v = p["vec3"];
    ...
    if (!v.isUndefined()) {
        ...
        mVec3 = std::make_shared<UnsignedVec3Out>(vec3);
